...
namespace CookItApp.Efectos
{
    public static class NumeroDeLineas
    {
        public static readonly BindableProperty ApplyNumberOfLinesProperty =
            BindableProperty.CreateAttached("ApplyNumberOfLines", typeof(bool), typeof(NumeroDeLineas), false,
                propertyChanged: OnApplyNumberOfLinesChanged);

        public static readonly BindableProperty NumberOfLinesProperty =
            BindableProperty.CreateAttached("NumberOfLines", typeof(int), typeof(NumeroDeLineas), 1);
